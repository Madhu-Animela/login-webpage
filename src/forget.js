        ...
        <div className="text-item">
            ...
            <div className="container-forgot">
                <form onSubmit={handleSubmit} className="form-container">
                    ...
                    <div>
                        <button type="submit" onClick={OnClickForgotButton} className="button-forgot" >Verify Email</button>
                    </div>
                </form>
                ...
                <div className={name1?"block-item":"none-item"}>
                    <div className="passwordnew"> 
                        <form onSubmit={handleSubmit1} className="form-container">
                            ...
                            <div className="hello">
                                <button type="submit" className="button-1" onClick={OnClickPassword}>Reset Password</button>
                            </div>    
                        </form>              
                    </div>
                </div>
